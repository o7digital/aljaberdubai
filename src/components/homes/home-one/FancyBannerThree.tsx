            ...
            <div className="row">
               <div className="col-xl-7 col-md-8 m-auto">
                  <div className="title-one mb-45 md-mb-30">
                     <h2>{t('contact.inquiry')} <span>{t('contact.feelFree')}<Image src={titleShape} alt="" className="lazy-img" /></span> {t('contact.toContact')}</h2>
                  </div>
                  <Link href="/contact" className="btn-five text-uppercase">{t('contact.sendMessage')}</Link>
               </div>
            </div>
         </div>
