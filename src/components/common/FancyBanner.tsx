               ...
               <div className="col-lg-6">
                  <div className="form-wrapper me-auto ms-auto me-lg-0">
                     <form onSubmit={(e) => e.preventDefault()}>
                        <input type="email" placeholder={t('journeySection.emailPlaceholder')} className={style ? "rounded-0" : ""} />
                        <button className={style ? "rounded-0" : ""}>{t('journeySection.getStarted')}</button>
                     </form>
